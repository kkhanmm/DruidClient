...
public class SpnegoClient {
    ...
    public SpnegoClient() {}
    public SpnegoClient(String principal, String keyTabLocation) {
        super();
        this.principal = principal;
        this.keyTabLocation = keyTabLocation;
    }
 
    public SpnegoClient(String principal, String keyTabLocation, String krb5Location) {
        this(principal, keyTabLocation);
        System.setProperty("java.security.krb5.conf", krb5Location);
    }
 
    public SpnegoClient(String principal, String keyTabLocation, boolean isDebug) {
        this(principal, keyTabLocation);
        if (isDebug) {
    ...
    public SpnegoClient(String principal, String keyTabLocation, String krb5Location, boolean isDebug) {
    ...
    public static void main(String[] args) throws UnsupportedOperationException, IOException {
        SpnegoClient restTest = new SpnegoClient("kkhan@MYCORP.NET","file://Users/kkhan/Downloads/vagrant-hdp26/kkhan.keytab", true);
        HttpResponse response = restTest.callRestUrl("http://one.hdp:8081/status","kkhan@MYCORP.NET");
